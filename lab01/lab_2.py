...
problem = {
    ...
    'initialA': ['c on a', 'space on b', 'space on c', 'a on table', 'space on table', 'b on table'],
    'goalA': ['space on c', 'space on b', 'space on a', 'a on table', 'b on table', 'c on table'],

    'initialB': ['space on c', 'space on b', 'space on a', 'a on table', 'b on table', 'c on table'],
    'goalB': ['c on table', 'b on c', 'a on b', 'space on a'],
